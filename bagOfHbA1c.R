...
write.table(numericalDrugsFrame, file = "~/R/GlCoSy/MLsource/numericalDrugsFrame_10y_2002to2012_3mBins_10yduration_chained_y.csv", sep=",", row.names = FALSE)

# write out dep variable (y)
write.table(y_vector, file = "~/R/GlCoSy/MLsource/5y_mortality_y_for_numericalDrugsFrame_10y_2002to2012_3mBins_10yduration_chained_y.csv", sep = ",", row.names = FALSE)
write.table(y_vector_isType1, file = "~/R/GlCoSy/MLsource/isType1_for_numericalDrugsFrame_10y_2002to2012_3mBins_10yduration_chained_y.csv", sep = ",", row.names = FALSE)
write.table(y_vector_deadAt_1_year, file = "~/R/GlCoSy/MLsource/1y_mortality_y_for_numericalDrugsFrame_10y_2002to2012_3mBins_10yduration_chained_y.csv", sep = ",", row.names = FALSE)
write.table(y_vector_deadAt_2_year, file = "~/R/GlCoSy/MLsource/2y_mortality_y_for_numericalDrugsFrame_10y_2002to2012_3mBins_10yduration_chained_y.csv", sep = ",", row.names = FALSE)
write.table(y_vector_deadAt_3_year, file = "~/R/GlCoSy/MLsource/3y_mortality_y_for_numericalDrugsFrame_10y_2002to2012_3mBins_10yduration_chained_y.csv", sep = ",", row.names = FALSE)
write.table(y_vector_deadAt_4_year, file = "~/R/GlCoSy/MLsource/4y_mortality_y_for_numericalDrugsFrame_10y_2002to2012_3mBins_10yduration_chained_y.csv", sep = ",", row.names = FALSE)
