...
# set time bins
sequence <- seq(0, 1 , 0.008) # for 20y follow up gives 1.9 month bins
...
write.table(numericalDrugsFrame, file = "~/R/GlCoSy/MLsource/numericalDrugsFrame_20y_125_chained_y.csv", sep=",", row.names = FALSE)

# write out dep variable (y)
write.table(y_vector, file = "~/R/GlCoSy/MLsource/3y_mortality_y_for_numericalDrugsFrame_20y_125_chained_y.csv", sep = ",", row.names = FALSE)
