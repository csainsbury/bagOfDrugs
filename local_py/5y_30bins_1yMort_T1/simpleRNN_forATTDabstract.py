...
import numpy as np
# import numpy as np
dataset = pd.read_csv('./interpolatedTS_hba1c_5y_30increments_2008-2013_locf_T1.csv')
# dataset = pd.read_csv('./hba1c_10y_2002to2012_3mBins_locf.csv')
ts_dataset = dataset.values

random_y_set = pd.read_csv('./hba1c_1y_mortality_y_5y_30increments_2008-2013_locf_T1.csv')
