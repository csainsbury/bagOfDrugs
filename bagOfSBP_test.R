...
write.table(values_plusID_forExport, file = "~/R/_workingDirectory/bagOfDrugs/local_py/interpolatedTS_sbp_5y_30increments_2008-2013_locf.csv", sep=",", row.names = FALSE)
...
#
write.table(y_vector_deadAt_1_year, file = "~/R/_workingDirectory/bagOfDrugs/local_py/sbp_1y_mortality_y_5y_30increments_2008-2013_locf.csv", sep = ",", row.names = FALSE)
...
write.table(y_vector_deadAt_3_year, file = "~/R/_workingDirectory/bagOfDrugs/local_py/sbp_3y_mortality_y_5y_30increments_2008-2013_locf.csv", sep = ",", row.names = FALSE)
#
write.table(y_vector_deadAt_4_year, file = "~/R/_workingDirectory/bagOfDrugs/local_py/sbp_4y_mortality_y_5y_30increments_2008-2013_locf.csv", sep = ",", row.names = FALSE)
